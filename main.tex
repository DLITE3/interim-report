...
\subsection{ソフトウェア}
\noindent
\space　後期のプロジェクト学習では、生成AIのAPIを活用し本格的にソフトウェア制作に取り掛かる。まずは風景から音楽を生成するシステムを完成させる。次に環境音からアートを生成するシステムを完成させる。最終的にRaspberry Piと連携させ、実用可能な段階まで開発を進める。
\Writer{伊丸岡}

\addcontentsline{toc}{chapter}{参考文献}
\begin{thebibliography}{参考文献の数}
