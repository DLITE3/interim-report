...
\subsection{ソフトウェア}
\Writer{伊丸岡朝陽}
\space 後期は生成AIのAPIを使って、本格的にソフトウェアの制作に取り掛かる。raspberry piと
連携をさせ、実用できる段階まで制作する。また中間発表会の質問にあったように、実際に生成AIで生成された音楽やアートが、元の景色や音を表現するものとして妥当性があるかを評価するため、
アンケートなどをとり、実用性を高めていきたい。
\end{document}